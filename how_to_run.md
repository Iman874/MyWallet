...
Hasil APK ada di **`build_apk/app-release.apk`**. File ini adalah **APK siap pasang** — salin ke device Android lalu buka untuk menginstall (pastikan "Sumber tidak dikenal" diizinkan di pengaturan). Tidak perlu tool tambahan.
